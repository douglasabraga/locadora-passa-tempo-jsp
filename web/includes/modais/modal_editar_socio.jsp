<!-- Modal EDITAR -->
<div class="modal fade" id="modalEditarSocio" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" class="titulo-formulario">Alterar Socio</h3>
                    ...
                    <form  method="post" action="CrtCadastrarCliente">
                        ...
                        <div class="col-sm-4">
                            <div class="grupo-entrada">
                                ...
                                <input type="text" name="cpf" id="cpf" class="campo" required>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="grupo-entrada">
                                ...
                                <input type="text" name="endereco" id="endereco" class="campo" required>
                            </div>
                        </div>
                    </div>
